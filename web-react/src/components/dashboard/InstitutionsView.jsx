...
export default function InstitutionsView() {
		...
		<div className="max-w-[1600px] mx-auto p-8 space-y-8">
			<div className="flex items-center justify-between gap-4 flex-wrap">
				<div>
					<h1 className="text-gray-900 dark:text-white mb-2 font-bold text-2xl">Instituciones</h1>
				...
				<motion.div
					...
					className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm flex flex-col justify-center"
				>
					<div className="flex items-start gap-4">
						...
						<div className="space-y-2">
							<h2 className="text-gray-900 dark:text-white">Institución principal</h2>
							<p className="text-gray-600 dark:text-gray-400 text-sm">
								Aún no hay una institución principal registrada para este proyecto de servicio comunitario.
							</p>
							<div className="grid sm:grid-cols-3 gap-4 mt-4">
								<div className="rounded-xl border border-dashed border-gray-200 dark:border-gray-700 p-3 flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm">
				...
				>
					<h3 className="text-gray-900 dark:text-white">Resumen de instituciones</h3>
			...
			<div className="space-y-4">
				<h3 className="text-gray-900 dark:text-white">Otras instituciones</h3>
				<motion.div
					initial={{ opacity: 0, y: 10 }}
					animate={{ opacity: 1, y: 0 }}
					className="rounded-2xl border border-dashed border-gray-200 dark:border-gray-700 p-8 bg-white dark:bg-gray-800 text-center text-gray-500 dark:text-gray-400"
				>
					<Building2 className="mx-auto mb-3 text-gray-400 dark:text-gray-500" size={32} />
