    ...
    <div className="max-w-[1400px] mx-auto p-8 space-y-8">
      <div className="text-center">
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-blue-500/30"
        >
          <HelpCircle className="text-white" size={40} />
        </motion.div>
        <h1 className="text-gray-900 mb-2">Centro de Ayuda</h1>
      ...
      >
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 rounded-2xl border border-gray-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-lg shadow-sm"
          />
        </div>
      </motion.div>
        ...
        {contactOptions.map((option, index) => {
          ...
          return (
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all cursor-pointer min-w-[280px] max-w-xs flex-1"
            >
              ...
              <p className="text-gray-600">{option.detail}</p>
            </motion.div>
          );
        })}
      </div>
      ...
      <div>
        <h2 className="text-gray-900 mb-6">Recursos Útiles</h2>
          ...
          {resources.map((resource, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ scale: 1.02 }}
                className="p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100/50 border border-blue-200 cursor-pointer group"
              >
