  ...
  return (
    <div className="max-w-[1200px] mx-auto p-8 space-y-8">
      <div>
        ...
        <p className="text-gray-600">Personaliza tu experiencia y preferencias del sistema.</p>
      </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-6 flex-wrap">
              ...
              <div>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-4 py-2 rounded-xl bg-blue-600 text-white text-sm mb-2"
                >
                  Cambiar foto de perfil
                </motion.button>
                <p className="text-xs text-gray-600">JPG, PNG o GIF (max. 2MB).</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-4">
              <div>
                ...
                <input
                  type="text"
                  placeholder="Nombre de ejemplo del usuario"
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none transition-all"
                />
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                <label className="block text-sm text-gray-700 mb-2">Carrera</label>
                <input
                  type="text"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg shadow-blue-500/30 text-sm"
            >
        ...
        >
          ...
          <div className="space-y-6 text-sm">
            <div className="flex items-center justify-between py-4 border-b border-gray-200 gap-4">
              <div>
                <p className="text-gray-900 mb-1">Notificaciones por correo</p>
                <p className="text-xs text-gray-600">Recibir resúmenes e información importante en tu bandeja.</p>
              </div>
              <button
                type="button"
            ...
            <div className="flex items-center justify-between py-4 border-b border-gray-200 gap-4">
              <div>
                <p className="text-gray-900 mb-1">Recordatorios de fechas límite</p>
                <p className="text-xs text-gray-600">Avisos antes de entregas importantes o cierres de periodo.</p>
              </div>
              <button
                type="button"
                onClick={() => setNotifications({ ...notifications, deadlines: !notifications.deadlines })}
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  notifications.deadlines ? 'bg-blue-600' : 'bg-gray-300'
                }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    notifications.deadlines ? 'translate-x-5' : 'translate-x-1'
                  }`}
                />
              </button>
            </div>
        ...
        >
          ...
          <div className="space-y-6 text-sm">
            ...
            <div className="pt-6 border-t border-gray-200">
              <h4 className="text-gray-900 mb-2">Autenticación de dos factores</h4>
              ...
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="px-6 py-3 rounded-xl bg-gray-100 text-gray-700 text-xs border border-dashed border-gray-300 cursor-default"
              >
