	...
	return (
		<div className="max-w-[1400px] mx-auto p-8 space-y-8">
			<div className="flex items-center justify-between flex-wrap gap-4">
				<div>
					<h1 className="text-gray-900 dark:text-white mb-2">Notificaciones</h1>
			...
			<div className="grid lg:grid-cols-3 gap-8">
				<div className="lg:col-span-2 space-y-4">
					...
					<motion.div
						...
						className="rounded-2xl bg-white dark:bg-gray-800 border border-dashed border-gray-200 dark:border-gray-700 p-8 flex flex-col items-center justify-center text-center text-gray-500 dark:text-gray-400"
					>
						<Bell className="mb-3 text-gray-400 dark:text-gray-500" size={40} />
						<p className="mb-1 text-gray-700 dark:text-gray-300">Todavía no tienes notificaciones.</p>
					</motion.div>
				</div>
