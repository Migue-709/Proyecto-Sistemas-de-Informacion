    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2 mb-2">
          <h5 className={`${completed ? 'line-through text-gray-500' : 'text-gray-900'}`}>{title}</h5>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-gray-900 mb-1">Próximas Tareas</h3>
      ...
      <div className="flex flex-col items-center justify-center py-8">
        ...
        <p className="text-gray-500 text-center">Aún no tienes tareas asignadas.<br/>Cuando se asignen, aparecerán aquí.</p>
      </div>
    </motion.div>
  );
}
