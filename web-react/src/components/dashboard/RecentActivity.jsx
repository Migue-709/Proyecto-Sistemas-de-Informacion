...
function ActivityItem({ icon: Icon, title, description, time, iconBg, index }) {
  return (
    <motion.div
      ...
      className="flex gap-4 p-4 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 group cursor-pointer"
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2 mb-1">
          <h5 className="text-gray-900 dark:text-white truncate">{title}</h5>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-gray-900 dark:text-white mb-1">Actividad Reciente</h3>
      ...
      <div className="flex flex-col items-center justify-center py-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-center">Aún no hay actividad registrada.<br/>Cuando la haya, aparecerá aquí.</p>
      </div>
    </motion.div>
  );
}
