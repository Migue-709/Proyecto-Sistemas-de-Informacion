...
import { Search, Bell, ChevronDown, ShieldCheck, LogOut, Menu } from 'lucide-react';

export default function AdminTopBar({ onSectionChange, onToggleSidebar }) {
    ...
    <div className="h-16 sm:h-20 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-4 sm:px-6 lg:px-8 sticky top-0 z-40 backdrop-blur-lg bg-white/80 dark:bg-gray-800/80">
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
            Gestión de proyectos y seguimiento de servicio comunitario
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 sm:gap-4 relative">
        <div className="relative hidden sm:block">
          ...
          <input
            type="text"
            placeholder="Buscar proyectos, estudiantes, autoridades..."
        ...
        <motion.button
          ...
          onClick={() => onSectionChange && onSectionChange('approvals')}
        >
          <ShieldCheck size={20} />
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="text-left hidden md:block">
              <p className="text-sm text-gray-900 dark:text-white">Nombre Autoridad</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">Rector / Decano / Coordinador</p>
            </div>
            <ChevronDown
              size={16}
            ...
            >
              <div className="p-4 bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/20 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <p className="text-gray-900 dark:text-white">Nombre Autoridad</p>
                    <p className="text-xs text-gray-600 dark:text-gray-400">autoridad@usm.edu.ve</p>
                  </div>
                </div>
                <p className="text-xs text-gray-600 dark:text-gray-400">
                  Acceso a rectoría, decanato, coordinación y direcciones.
                </p>
              </div>
